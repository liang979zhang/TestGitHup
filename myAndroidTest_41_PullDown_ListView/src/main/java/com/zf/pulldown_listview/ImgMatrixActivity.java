...
import com.zf.pulldown_listview.cusview.MyCusListView2;
import com.zf.pulldown_listview.cusview.MyCusListView2.OnRefreshListener;
...
public class ImgMatrixActivity extends Activity {
	protected static final int REF = 0x1;
	private MyCusListView2 myCuLv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_img_matrix);
		myCuLv = (MyCusListView2) findViewById(R.id.myCuLv);
	...
	static class MyHandler extends Handler{
		WeakReference<ImgMatrixActivity> mActivity;
		
		public MyHandler(ImgMatrixActivity activity) {
			mActivity = new WeakReference<ImgMatrixActivity>(activity);
		}
		
		@Override
		public void handleMessage(Message msg) {
			super.handleMessage(msg);
			ImgMatrixActivity mainActivity = mActivity.get();
			switch (msg.what) {
			case REF:
